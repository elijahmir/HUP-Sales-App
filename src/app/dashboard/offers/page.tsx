    ...
    const handleDownloadReport = async (group: PropertyGroup) => {
        ...
        const offers: OfferData[] = group.offers.map((o) => {
            ...
            return {
                ...
                subjectToSaleAddress: fd.subjectToSaleAddress,
                subjectToSalePrice: fd.subjectToSalePrice,
                subjectToSaleUnderContract: fd.subjectToSaleUnderContract,
                subjectToSaleCompletionDate: fd.subjectToSaleCompletionDate,
