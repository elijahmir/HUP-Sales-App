...
={
  ...
  "trigger_inputs": {
    ...
    "taswater_cancel_bpay": "{{$json.body.taswater_cancel_bpay || 'Not Applicable'}}",
    "taswater_cancel_direct_debit": "{{$json.body.taswater_cancel_direct_debit || 'Not Applicable'}}",
    "taswater_change_ownership": "{{$json.body.taswater_change_ownership || 'Not Applicable'}}",
